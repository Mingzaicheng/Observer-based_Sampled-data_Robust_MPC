...
legend({  'Algorithm 1 for case (b),~$x_1$', 'Algorithm 1 for case (b),~$\hat x_{1}$'}, 'Interpreter', 'latex');
...
legend({ 'Algorithm 1 for case (b),~$x_2$', 'Algorithm 1 for case (b),~$\hat x_{2}$'}, 'Interpreter', 'latex');
...
xlim([-0.025,0.4]);
ylim([-0.5,7.5]);
legend({'~$\hat x$','Algorithm 1 for case (b),~$x$','Algorithm 1 for case (b),~$\hat x$'},'Interpreter','latex');
...
ylim([-10,1]);
legend({'Algorithm 1 for case (b)'},'Interpreter','latex');
box on
set(gca, 'Box', 'on')
